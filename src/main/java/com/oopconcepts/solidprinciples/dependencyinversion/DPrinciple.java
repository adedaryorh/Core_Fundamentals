...
For example, let’s take a look at the garden class. In the garden constructor,
* it sets the type of flower to a “daisy”. Let’s now go to the “DPrinciple” class,
* where we create a new instance of a garden. After the garden is created,
* we print out the type of flower that’s in the garden, and it prints “daisy”.

Because we created this dependency in the constructor, now garden is tightly coupled to the creation of its dependency,
* flower of the String daisy. Every time we create a garden, it automatically makes it a daisy garden.
